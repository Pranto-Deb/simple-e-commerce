...
(function(b) {
    if (b.fn.ajaxForm == undefined) {
        b.getScript("/vendor/fileupload/jquery.form.js")
    }
    var a = {};
    a.fileapi = b("<input type='file' accept='text/*|image/*|.pdf|.doc|.docx|.docx|.csv|.xlsx|.xls'  />").get(0).files !== undefined;
    a.formdata = window.FormData !== undefined;
    b.fn.uploadFile = function(t) {
        
        var r = b.extend({url: "", method: "POST", enctype: "multipart/form-data", formData: null, returnType: null,  folderName: null, allowedTypes: "*", fileName: "file", formData:{}, dynamicFormData: function() {
                return{}
